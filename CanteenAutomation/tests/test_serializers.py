...
from CafeApp.serializers import UserSerializer, MenuItemSerializer, OrderSerializer, AccountDetailsSerializer, CanteenSerializer, feedbackserializer, OrderDetailSerializer, ALLCanteenSerializer, NewItemSerializer
...
class SerializerTestCase(TestCase):
    def setUp(self):
        ...
        self.feedback = feedback.objects.create(order_id=self.order, review='Test Review', rating=5)
    ...
    def test_account_details_serializer_partial_update(self):
        ...
        serializer = AccountDetailsSerializer(instance=self.profile, data=data, partial=True)
