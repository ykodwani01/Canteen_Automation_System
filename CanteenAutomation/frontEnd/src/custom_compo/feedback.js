            ...
            {gotAccountDetails && gotCartDetails && isLoaded ? <div style={{ backgroundColor: '#DED8D8', display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
                ...
                <footer style={{ display: 'flex', justifyContent: 'center', backgroundColor: '#C31E2C', width: '100%', marginTop: '70px', paddingTop: '10px' }}>
                    ...
                    <div style={{ padding: '50px' }}>
                        ...
                        <div style={{ marginBottom: "20px" }}><Link component={LINK} to="https://canteenautomation-cc940.web.app/canteens" underline="hover" style={{ color: '#DAC6C7' }} >{"Browse Food"}</Link></div>
                        <div style={{ marginBottom: "20px" }}><Link component={LINK} to="https://canteenautomation-cc940.web.app/aboutus" underline="hover" style={{ color: '#DAC6C7' }} >{"Registrations"}</Link></div>
                    </div>
                    <div style={{ padding: '50px' }}>
